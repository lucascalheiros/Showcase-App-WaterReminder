package com.github.lucascalheiros.waterreminder.domain.watermanagement.test
...
val consumedWater1InDay1 = ConsumedWater(
    1,
    volumeValue1,
    1.toDuration(DurationUnit.DAYS).inWholeMilliseconds,
    waterSourceType1
)
val consumedWater2InDay2 = ConsumedWater(
    2,
    volumeValue1,
    2.toDuration(DurationUnit.DAYS).inWholeMilliseconds,
    waterSourceType1
)
val consumedWater3InDay3 = ConsumedWater(
    3,
    volumeValue1,
    3.toDuration(DurationUnit.DAYS).inWholeMilliseconds,
    waterSourceType1
)
val consumedWater4InDay4 = ConsumedWater(
    4,
    volumeValue1,
    4.toDuration(DurationUnit.DAYS).inWholeMilliseconds,
    waterSourceType1
)
val consumedWater5InDay5 = ConsumedWater(
    5,
    volumeValue1,
    5.toDuration(DurationUnit.DAYS).inWholeMilliseconds,
    waterSourceType1
)
val consumedWater6InDay4dot5 = ConsumedWater(
    6,
    volumeValue1,
    4.toDuration(DurationUnit.DAYS).inWholeMilliseconds - 0.5.toDuration(DurationUnit.DAYS).inWholeMilliseconds,
    waterSourceType1
)
