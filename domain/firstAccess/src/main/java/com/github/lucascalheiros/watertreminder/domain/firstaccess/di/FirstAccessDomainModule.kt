...
import com.github.lucascalheiros.watertreminder.domain.firstaccess.domain.usecases.SetFirstDailyIntakeUseCase
...
import com.github.lucascalheiros.watertreminder.domain.firstaccess.domain.usecases.impl.CompleteFirstAccessFlowUseCaseImpl
import com.github.lucascalheiros.watertreminder.domain.firstaccess.domain.usecases.impl.GetFirstAccessNotificationDataUseCaseImpl
import com.github.lucascalheiros.watertreminder.domain.firstaccess.domain.usecases.impl.IsDailyIntakeFirstSetUseCaseImpl
import com.github.lucascalheiros.watertreminder.domain.firstaccess.domain.usecases.impl.IsFirstAccessCompletedUseCaseImpl
import com.github.lucascalheiros.watertreminder.domain.firstaccess.domain.usecases.impl.SetFirstAccessNotificationStateUseCaseImpl
import com.github.lucascalheiros.watertreminder.domain.firstaccess.domain.usecases.impl.SetFirstDailyIntakeUseCaseImpl
import com.github.lucascalheiros.watertreminder.domain.firstaccess.domain.usecases.impl.SetNotificationFrequencyTimeUseCaseImpl
import com.github.lucascalheiros.watertreminder.domain.firstaccess.domain.usecases.impl.SetStartNotificationTimeUseCaseImpl
import com.github.lucascalheiros.watertreminder.domain.firstaccess.domain.usecases.impl.SetStopNotificationTimeUseCaseImpl
